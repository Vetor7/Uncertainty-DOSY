...
DOSYData = DOSYData(1:15,:);
b = b(1:15);
[peaks, idx_peaks] = findpeaks(DOSYData(1, :), 'MinPeakHeight', 0.043, 'MinPeakProminence',0.001);
...
save('QG_net_input.mat', 'S', 'ppm', 'b', 'idx_peaks', 'HNMR', '-mat');