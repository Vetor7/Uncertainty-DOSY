...
def process_result(mean, ppm, var, idx_peaks, HNMR, expand=5, expand_margin=1, expand_margin_y=0):
    ...
    merged_boxes = find_box(spec_var, expand_margin, expand_margin_x=expand, expand_margin_y=expand_margin_y) 
...
def result_process(type):
    ...
    "GSP": (0.036, 0.9, "linear", 0.55, 2),
    "M6": (0.035, 0.7, "quadratic", 0.6, 20),
    "MPD": (0.06, 0.9, "linear", 0.6, 5),
    "FPH": (0.05, 0.7, "linear", 0.6, 20),
    "AMO": (0.03, 0.9, "linear", 0.45, 20),
    "AD": (0.02, 0.9, "quadratic", 0.45, 10),
